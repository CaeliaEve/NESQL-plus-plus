...
final class RawExportReportAssembler {
    ...
    static void apply(
        ...
        report.counts.nativeUiRects = factCounts.nativeUiRects;
        report.counts.nativeUiPrimitives = factCounts.nativeUiPrimitives;
        ...
        report.counts.nativeUiRectBoundsViolations = factCounts.nativeUiRectBoundsViolations;
        report.counts.nativeUiPrimitiveBoundsViolations = factCounts.nativeUiPrimitiveBoundsViolations;
        ...
        report.counts.nativeUiInteractionContractViolations = factCounts.nativeUiInteractionContractViolations;
        ...
        report.counts.nativeUiRectBoundsViolationSamples = factCounts.nativeUiRectBoundsViolationSamples;
        report.counts.nativeUiPrimitiveBoundsViolationSamples = factCounts.nativeUiPrimitiveBoundsViolationSamples;
